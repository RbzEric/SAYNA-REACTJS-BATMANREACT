...
import { db, storage } from "../components/config"; // Assurez-vous que les chemins sont corrects
...
const AddProductForm = () => {
    ...
    const addProduct = async (e) => {
        ...
        try {
            ...
            // Étape 2: Obtenir l'URL de téléchargement de l'image
            const imageUrl = await getDownloadURL(storageRef);

            // Étape 3: Ajouter les informations du produit dans Firestore
