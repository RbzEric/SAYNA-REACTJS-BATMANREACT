...
const Panier = () => {
    ...
    const handleCheckout = () => {
        ...
        navigate('/commande'); // Sinon, procéder à la commande
                }
            };
    ...
    return (
        <div className='panier-body'>
            <div className='nav-link'>
                <NavLink to="/eshop" className="nav-link">E-shop</NavLink> / <NavLink to="/panier" className="nav-link">Panier</NavLink>
            </div>
            ...
            <div className="action-buttons">
                <button onClick={() => navigate('/recapPanier')} className="continue-shopping-btn">Continuer mes achats</button>
