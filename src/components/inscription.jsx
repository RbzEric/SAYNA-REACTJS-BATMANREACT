...
const Inscription = () => {
    const { login } = useContext(AuthContext); // Appeler la fonction login pour connecter l'utilisateur
    ...
    const handleSubmit = (e) => {
        ...
        if (formData.motDePasse === formData.confirmationMotDePasse) {
            ...
            // Redirection vers la page de commande ou autre
        } else {
    ...
    return (
        <div className='login-signup'>
            <div className='nav-link'>
                <NavLink to="/eshop" className='nav-link'>E-shop</NavLink> / <NavLink to="/panier" className='nav-link'>Panier</NavLink> / <NavLink to="/recapPanier" className='nav-link'>Récapitulatif de votre panier</NavLink> / <NavLink to="/inscription" className='nav-link'>Authentification</NavLink>
            </div>
