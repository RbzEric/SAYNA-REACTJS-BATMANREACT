    ...
    return (
        <div className='recap-body'>
            <div className='nav-link'>
                <NavLink to="/eshop" className='nav-link'>E-shop</NavLink> / <NavLink to="/panier" className='nav-link'>Panier</NavLink> / <NavLink to="/recapPanier" className='nav-link'>Récapitulatif de votre panier</NavLink>
            </div>
            {cart.length === 0 ? (
            ...
            <div className="action-buttons">
                <button onClick={() => navigate('/panier')} className="comeback-shopping-btn">Revenir au Panier</button>
